<%@ Page Title="" Language="C#" MasterPageFile="~/WebUI.Master" AutoEventWireup="true" CodeBehind="CreateProject.aspx.cs" Inherits="WebUI.CreateProject" %>
...
&nbsp;&nbsp; </td>
        ...
        <tr>
            ...
            <td class="auto-style17">&nbsp;</td>
            <td class="auto-style19">
                <asp:Button ID="btnCreate" runat="server" Text="Create" Height="31px" Width="89px" />
                </td>
            <td>&nbsp;</td>
        </tr>
    </table>
